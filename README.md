...
This PoC explores how to replay ESP32 crashes by decoding backtraces/coredumps with [ESP Exception Decoder](https://github.com/dankeboy36/esp-exception-decoder) and its [TraceBreaker](https://github.com/dankeboy36/trbr) engine, while borrowing concepts from Datadog Exception Replay: <https://docs.datadoghq.com/developers/ide_plugins/vscode/#exception-replay>, <https://docs.datadoghq.com/tracing/error_tracking/exception_replay/>.
